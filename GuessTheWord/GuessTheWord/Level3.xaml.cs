...
namespace GuessTheWord
{
    ...
    public sealed partial class Level3 : Page
    {
        ...
        public Level3()
        {
            ...
            txtB5.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Center;
            txtB6.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Center;
            txtB7.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Center;
            txtB8.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Center;
            txtB9.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Center;
        ...
        private void Latter_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if ((txtB1.Text != "") && (txtB2.Text != "") && (txtB3.Text != "") && (txtB4.Text != "") && (txtB5.Text == ""))
                txtB5.Text = (String)((Button)sender).Content;
            else if ((txtB1.Text != "") && (txtB2.Text != "") && (txtB3.Text != "") && (txtB4.Text != "") && (txtB5.Text != "") && (txtB6.Text == ""))
                txtB6.Text = (String)((Button)sender).Content;
            else if ((txtB1.Text != "") && (txtB2.Text != "") && (txtB3.Text != "") && (txtB4.Text != "") && (txtB5.Text != "") && (txtB6.Text != "") && (txtB7.Text == ""))
                txtB7.Text = (String)((Button)sender).Content;
            else if ((txtB1.Text != "") && (txtB2.Text != "") && (txtB3.Text != "") && (txtB4.Text != "") && (txtB5.Text != "") && (txtB6.Text != "") && (txtB7.Text != "") && (txtB8.Text == ""))
                txtB8.Text = (String)((Button)sender).Content;
            else if ((txtB1.Text != "") && (txtB2.Text != "") && (txtB3.Text != "") && (txtB4.Text != "") && (txtB5.Text != "") && (txtB6.Text != "") && (txtB7.Text != "") && (txtB8.Text != "") && (txtB9.Text == ""))
                txtB9.Text = (String)((Button)sender).Content;
        ...
        private void txtB5_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            txtB5.Text = "";
            txtB5.Foreground = new SolidColorBrush(Colors.Black);
        }

        private async void eSubmit_Tapped(object sender, TappedRoutedEventArgs e)
        {
            if (((txtB1.Text + txtB2.Text + txtB3.Text + txtB4.Text + txtB5.Text + txtB6.Text + txtB7.Text + txtB8.Text + txtB9.Text)).ToLower().Equals("education"))
            {
            ...
            else
            {
                ...
                txtB5.Foreground = new SolidColorBrush(Colors.Red);
                txtB6.Foreground = new SolidColorBrush(Colors.Red);
                txtB7.Foreground = new SolidColorBrush(Colors.Red);
                txtB8.Foreground = new SolidColorBrush(Colors.Red);
                txtB9.Foreground = new SolidColorBrush(Colors.Red);
            }
        }


        private void txtB6_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            txtB6.Text = "";
            txtB6.Foreground = new SolidColorBrush(Colors.Black);
        }


        private void txtB7_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            txtB7.Text = "";
            txtB7.Foreground = new SolidColorBrush(Colors.Black);
        }

        private void txtB8_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            txtB8.Text = "";
            txtB8.Foreground = new SolidColorBrush(Colors.Black);
        }

        private void txtB9_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            txtB9.Text="";
            txtB9.Foreground = new SolidColorBrush(Colors.Black);
        }
